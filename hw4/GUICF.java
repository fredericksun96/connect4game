...
public class GUICF extends CFGame{
	...
	public GUICF(CFPlayer ai) {
		...
		//since doesn't matter in this one, have both p1 and p2 point to one AI
		//doesn't matter cause we'll implement a new button
		p1 = ai; p2 = ai;
		...
		//I'm sorry. I'm about to write a new function for every single button because I'm too tired and it's too late
	...
	public static void main(String[] args){
		RandomAI ai1 = new RandomAI(); FredSunAI ai2 = new FredSunAI();
